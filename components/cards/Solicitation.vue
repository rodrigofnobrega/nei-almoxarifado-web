...
export default {
	components: { Card },
	props: ['person', 'requestedAt', 'expirationDate', 'message', 'itemName', 'itemTagging', 'quantity', 'itemQuantity']
}
</script>

<template>
	<Card>
		<template v-slot:header> <h5> Solicitação </h5> </template>
			...
			<div class="row">
				<div class="col-6">
					...
					<div class="mb-3"> 
						...
						<textarea readonly class="form-control" :value="message"> </textarea>
					</div>	
				</div>
				<div class="col-6">
					<div class="mb-3"> 
