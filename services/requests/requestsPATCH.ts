...
export const requestAccept = async (userStore, request_id) => {
    ...
    const { data } = await axios.patch(`http://18.230.148.248:8080/api/v1/requests/accept/${request_id}`, null, {
        headers: {
...
export const requestDecline = async (userStore, request_id) => {
    ...
    const { data } = await axios.patch(
        `http://18.230.148.248:8080/api/v1/requests/decline/${request_id}`,
