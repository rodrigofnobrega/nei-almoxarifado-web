...
export const useStorageStore = defineStore('storage', {
    state: () => ({
      items: [
        {name: "Cartolina Amarela", sipac: null, type: "Unidade", qtd: 5, history: ["03/03/2023 13:30:00 - Adicionado", "03/03/2023 14:32:34 - Consumido"], storage: "almoxarifado-escolar"},
